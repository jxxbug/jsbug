    ...
    for (const v of event["Message"].split("&")) {
      ...
      switch (TENCENTSCF_SOURCE_TYPE) {
        ...
        case 'git':
          ...
          request(`https://raw.githubusercontent.com/ZFeng3242/MyScripts/main/${v}.js`, function (error, response, body) {
            eval(response.body)
          })
          break;
        case 'custom':
        ...
        default:
          ...
          request(`https://gitee.com/ZFeng3242/JD-haoyangmao/raw/main/${v}.js`, function (error, response, body) {
            eval(response.body)
          })
          break;
      }
